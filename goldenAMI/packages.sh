...
installModCloudflare() {
    sudo yum install libtool git apr apr-devel apr-util apr-util-devel -y
    cd /usr/local/src
    sudo git clone https://github.com/cloudflare/mod_cloudflare.git
...
echo "Installing require php, Node and Apache based packages"
installNode

echo "Installing php"
installPhp

echo "Installing Mod-Cloudflare"
installModCloudflare

echo "Installing Php Pear packages"
installPearPackages
